    ...
    public class IndexModel : PageModel
    {
            ...
            int? pageIndex)
        {
            ...
            if (!_signin.IsSignedIn(User))
            {
                ...
                Data.EntityList = new PaginatedList<StudySession>([], 0, 0, 0);
                return;
            }
            ...
            if (searchTitle?.Length > 0 || searchStatus?.Length > 0)
            {
                pageIndex = 1;
            }
            else
            ...
            if (Enum.TryParse<StudySessionStatus>(searchStatus, true, out var parsedStatus))
            {

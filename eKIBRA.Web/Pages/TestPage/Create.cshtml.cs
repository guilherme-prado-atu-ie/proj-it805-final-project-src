...
namespace eKIBRA.Web.Pages.TestPage
{
    public class CreateModel : PageModel
    {
        ...
        [BindProperty]
        public CreateViewModel Input { get; set; } = new() { DeckId = string.Empty, DeckTitle = string.Empty, Description = string.Empty };
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _context.TestSessions.Add(data);
            try
            {
             ...
             */
            StatusMessage = MessageType.Success + "Test session created.";
            return Page();
        }
        ...
        public IActionResult HandleCreateException(Exception e)
        {
            if (e is DbUpdateException
                ...
                StatusMessage = MessageType.Warning
                                + $"Cannot create a new Test session. Title '{Input.Title}' is duplicated.";
            else
                StatusMessage = MessageType.Error
                                + "Fail to create a new Test session.";

            _logger.LogError(e, "An error occurred while creating a new Test session.");
            return Page();
        }
    }
}
